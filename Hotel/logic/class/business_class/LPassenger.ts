...
export  default class LogicPassenger
{
   ...
   //SETTERS
    ...
    this.validatePassword();
     let passengersearch = await LGetPassenger.getLPassenger(this.idcard);
     if (passengersearch != null) {
      ...
      else
       {
         ...
         const actpasse=await LCUDPassenger.changestatePassenger(passengersearch.idcard,"Active");
         return actpasse;
     ...
     const reguser=await LCUDPassenger.registerPassenger(dto);
     return reguser
   }
   ...
   update=async()=>
   {
     ...
     this.salt=passh.salt;
    const dto=this.getDTO();
    const updateuser=await LCUDPassenger.updatePassenger(dto);
    return updateuser
   ...
   disable=async()=>
      {
       ...
       const dto=this.getDTO();
       const deluser=await LCUDPassenger.changestatePassenger(dto.idcard,"Inactive");
       return deluser
      }
